"""
  ...
  Descripción: Este es el agloritmo de ordenamiento por mezcla.
  En esta implementacion trabajamos en base a subarreglos.
...
def split(arr: list) -> list: 
    """ La función  split divide el arreglo en dos subarreglos
...
def mergeSort(arr : list) -> None: 
    """
    La función mergeSort recibe como parámetro un arreglo.
    Ordena el arreglo dado utilizando el algoritmo por mezcla
    """
